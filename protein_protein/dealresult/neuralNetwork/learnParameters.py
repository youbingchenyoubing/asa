...
def expandfeature(filename)
    ...
    for line in f_original:
        ...
        f_reuslt.write(line[0]+':'+str(newvalue)+':'+str((0.05*newvalue+1.09)**2)+':'+str((newvalue+1.06)**5)+':'+str((1.0/newvalue)**-5)+':'+str(math.log10(math.fabs(newvalue)))+':'+str(math.sqrt(newvalue)))
        f_result('\n')
    f_original.close()
    f_result.close()
